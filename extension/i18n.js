...
const STRINGS = {
  ja: {
    ...
    field_help_tavily_pre:     '取得方法:',
    field_help_tavily_post:    'でアカウント作成 → APIキーをコピーして貼り付けてください。',
  ...
  en: {
    ...
    field_help_tavily_pre:     'How to get it:',
    field_help_tavily_post:    '→ Create an account, then copy and paste your API key.',
